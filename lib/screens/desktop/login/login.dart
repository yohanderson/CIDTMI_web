...
class LogIn extends StatefulWidget {
  ...
  const LogIn({Key? key, required this.selectedAuth}) : super(key: key);
          ...
          SizedBox(
            ...
            child: Row(
              ...
              children: [
                const SizedBox(),
                InkWell(
                  onTap: () => widget.selectedAuth.value = 'password',
                ...
                if (_isLoadingLogin == false ) {
                  ...
                  try {
                    ...
                    if (response.statusCode == 200) {
                      ...
                      // Establecer la fecha de expiración para un día después
                      DateTime expiryDate = DateTime.now().add(const Duration(days: 1));

                      // Guardar el token en las cookies del navegador
                      html.document.cookie =
                      'auth_token=$token; expires=${expiryDate.toUtc().toIso8601String()}; path=/';
                      ...
                      connectionDatesBlocs.getOrders(userMap['user_id'].toString());
        ...
        const Padding(
          ...
          Padding(
            ...
            child: TextButton(
              ...
              onPressed: () => widget.selectedAuth.value = 'register',
