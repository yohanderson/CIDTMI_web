                    ...
                    : () async {
                        if (_isLoadingRegister == false) {
                          ...
                          var body = jsonEncode({
                            ...
                            'sur_name': userSurnameController.text,
                                      ...
                                      child: RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            ...
                                            TextSpan(
                                              text: email,
                                              // La variable email que deseas resaltar
                                              style: const TextStyle(
                                                color: Colors.blue,
                                                // Color azul para la palabra "email"
                                                decoration:
                                            ...
                                            const TextSpan(
                                              text:
                                                  ' Por favor, verifica tu correo electrónico y haz clic en el enlace de verificación para activar tu cuenta.',
                                            ),
                                          ],
                                        ),
                                      ),
                        ...
                        if (_isLoadingGoogle == false) {
                          ...
                          if (googleData != null) {
                            ...
                            if (googleIdToken != null &&
                                ...
                                firstName != null) {
                              final Uri url =
                                  Uri.parse('$connection$route'); // url backend
