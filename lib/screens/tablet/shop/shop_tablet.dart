import 'package:cidtmi/screens/tablet/shop/product_tablet.dart';
...
class StoreTabletView extends StatefulWidget {
  final void Function(int) goToIndex;
  const StoreTabletView({super.key, required this.goToIndex,});

  @override
  State<StoreTabletView> createState() => _StoreTabletViewState();
}

class _StoreTabletViewState extends State<StoreTabletView> {
                                                ...
                                                child: InkWell(
                                                  onTap: () async {
                                                    final result = await Navigator.push(
                                                      context,
                                                      MaterialPageRoute(builder: (context) => ProductTablet(
                                                        producto: producto,
                                                        categoria: producto['id_categoria'].toString(),
                                                        productos: productos,
                                                      )),
                                                    );
                                                    if (result != null) {
                                                      ...
                                                      Positioned(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () {
                                                            ...
                                                            final success = cart.addProduct(producto, _counterProduct);
                                                            if (success) {
